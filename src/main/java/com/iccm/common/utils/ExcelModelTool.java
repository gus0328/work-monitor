...
public class ExcelModelTool {
    ...
    @Value("${com.ccit.officeModelPath}")
     ...
     * @throws Exception
     */
//    public static void export(HttpServletRequest request, HttpServletResponse response, String model, SheetData[] sheetDatas, List<List> data, String fileName)throws Exception{
//        for(int i =0;i < data.size();i++){
//            for(Object object:data.get(i)){
//                sheetDatas[i].addData(object);
//            }
//        }
//        response.setContentType("multipart/form-data");
//        if(model.indexOf(".xlsx")==-1){
//            fileName = CommonUtil.getFileName(fileName+".xls",request);
//        }else{
//            fileName = CommonUtil.getFileName(fileName+".xlsx",request);
//        }
//        response.setHeader("Content-Disposition", "attachment;fileName="+fileName);
//        writeData(model,response.getOutputStream() ,sheetDatas);
//    }
...
//        Workbook wb = null;
//        try {
//            InputStream input = ExcelModelTool.class.getResourceAsStream(modelPath + model);
//            if(input == null) {
//                throw new RuntimeException("model excel file load error :"+modelPath + model + " , check model file is exists !");
//            }
...
//            //e.printStackTrace();
//            throw new RuntimeException("model excel file load error :"+modelPath + model);
//        }
...
//                    Object cellValue;
//                    if("syshowNum".equals(key)){
//                        cellValue = rowNum;
//                    }else{
//                        cellValue = CommonUtil.getFieldValueByName(key, o);
//                    }
